...
def run_game():
    ...
    while not game_over:
        ...
        while game_close:
            pygame.game.display.fill(preto)
        ...
        if x == target_x and y == target_y:
            target_x = round(random,time.randrange(0, width-snake_size) / 10.0) * 10.0
            target_y = round(random,time.randrange(0, height-snake_size) / 10.0) * 10.0
